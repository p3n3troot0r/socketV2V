		       ...
		       struct ocb_setup *setup)
{
	...
	// trying this to set a wildcard BSSID
...
/* TODO: modify u.ocb to drop work sync like ibss
 *void ieee80211_ocb_stop(struct ieee80211_sub_if_data *sdata)
{
	struct ieee80211_if_ocb *ifocb = &sdata->u.ocb;

	cancel_work_sync(&ifocb->csa_connection_drop_work);
}
*/
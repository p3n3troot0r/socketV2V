...
int ieee80211_do_open(struct wireless_dev *wdev, bool coming_up)
{
	...
	default:
		...
		case NL80211_IFTYPE_AP:
		case NL80211_IFTYPE_MESH_POINT:
		case NL80211_IFTYPE_OCB: /* trying for 802.11p */
			netif_carrier_off(dev);
			break;
//		case NL80211_IFTYPE_OCB:	
		case NL80211_IFTYPE_WDS:
			      ...
			      bool going_down)
{
	...
	case NL80211_IFTYPE_OCB: /* i think this helps */
		...
		//ieee80211_ocb_stop(sdata);
		//printk("%s:%s Breaking ocb ocb_stop worked \n",__FILE__,__FUNCTION__);
		//break;
	case NL80211_IFTYPE_ADHOC:
				  ...
				  enum nl80211_iftype type)
{
	...
	case NL80211_IFTYPE_STATION:
		...
		break;
	case NL80211_IFTYPE_OCB:
		sdata->vif.bss_conf.bssid = bssid_wildcard; // TODO is this def working?

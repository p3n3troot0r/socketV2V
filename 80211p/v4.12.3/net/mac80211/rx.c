				       ...
				       struct sk_buff_head *frames)
{
	...
	if (!ieee80211_is_data_qos(hdr->frame_control) ||
		...
		/*if(local->hw.wiphy->dot11OCBActivated == 1) {
			printk("%s:%s OCB active, exiting immediately\n",__FILE__,__FUNCTION__);
		}*/
		goto dont_reorder;
	}
...
__ieee80211_data_to_8023(struct ieee80211_rx_data *rx, bool *port_control)
{
	...
	*port_control = false;
	...
	/* TODO: should we add a clause here for if is multicast and vif type is OCB? */
...
static bool ieee80211_frame_allowed(struct ieee80211_rx_data *rx, __le16 fc)
{
	...
	/* TODO: need we add any clauses for 802.11p? */
...
ieee80211_rx_h_data(struct ieee80211_rx_data *rx)
{
	...
	//printk("%s:%s reached end of function \n",__FILE__,__FUNCTION__);
